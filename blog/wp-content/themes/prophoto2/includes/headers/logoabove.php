	<?php if ( $use_logo ) { ?><div id="logo">
		...
		<<?php echo $h; ?> id="alt-h1"><a href="<?php echo get_option('home') ?>/" title="<?php bloginfo('name') ?>" rel="home"><?php bloginfo( 'name' ); echo " &raquo; "; bloginfo( 'description'); ?></a></<?php echo $h; ?>><?php } ?>
