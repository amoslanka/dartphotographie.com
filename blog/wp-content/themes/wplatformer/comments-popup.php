...
<?php foreach ($comments as $comment) { ?>
	...
	<?php comment_text() ?>
	<p><?php echo get_avatar( get_comment_author_email(), $size = '32' ); ?><cite><?php comment_type('Comment', 'Trackback', 'Pingback'); ?> by <?php comment_author_link() ?> &#8212; <?php comment_date() ?> @ <a href="#comment-<?php comment_ID() ?>"><?php comment_time() ?></a></cite></p>
	</li>
