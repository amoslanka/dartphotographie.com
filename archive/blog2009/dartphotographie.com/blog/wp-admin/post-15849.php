...
<input type="hidden" id="_wpnonce" name="_wpnonce" value="05d444e033" /><input type="hidden" name="_wp_http_referer" value="/blog/wp-admin/post.php?action=edit&amp;post=237" />
...
<input type='hidden' id='post_ID' name='post_ID' value='237' />
...
<a class="preview button" href="../matthew-perryman-jones/index.html" target="wp-preview" id="post-preview" tabindex="4">Preview</a>
...
<div class="misc-pub-section curtime misc-pub-section-last">
	<span id="timestamp">
	Published on: <b>Mar 28, 2009 @ 21:14</b></span>
...
<input type="hidden" id="hidden_mn" name="hidden_mn" value="14" />
...
<a class="submitdelete deletion" href="post-30953.php" onclick="if ( confirm('You are about to delete this post \'Matthew Perryman Jones\'\n  \'Cancel\' to stop, \'OK\' to delete.') ) {return true;}return false;">Delete</a>
</div>
...
<div id="titlediv">
<div id="titlewrap">
	<input type="text" name="post_title" size="30" tabindex="1" value="Matthew Perryman Jones" id="title" autocomplete="off" />
</div>
<div class="inside">
	<div id="edit-slug-box">
<strong>Permalink:</strong>
<span id="sample-permalink">http://dartphotographie.com/blog/<span id="editable-post-name" title="Click to edit this part of the permalink">matthew-perryman-jones</span><span id="editable-post-name-full">matthew-perryman-jones</span>/</span>
<span id="edit-slug-buttons"><a href="#post_name" class="edit-slug button" onclick="edit_permalink(237); return false;">Edit</a></span>
	</div>
</div>
</div>
...
<div id="postdivrich" class="postarea">
	...
	<div id="editor-toolbar">
			...
			Upload/Insert 
	<a href="media-upload-2240.php" id="add_image" class="thickbox" title='Add an Image'><img src='images/media-button-image.gif' alt='Add an Image' /></a>
	<a href="media-upload-28306.php" id="add_video" class="thickbox" title='Add Video'><img src='images/media-button-video.gif' alt='Add Video' /></a>
	<a href="media-upload-41276.php" id="add_audio" class="thickbox" title='Add Audio'><img src='images/media-button-music.gif' alt='Add Audio' /></a>
	<a href="media-upload-59742.php" id="add_media" class="thickbox" title='Add Media'><img src='images/media-button-other.gif' alt='Add Media' /></a>
			</div>
			</div>
	...
	<div id='editorcontainer'><textarea rows='10' cols='40' name='content' tabindex='2' id='content'>&lt;p&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_6302.jpg" /&gt;&lt;br /&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_6378.jpg" /&gt;&lt;br /&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_6301.jpg" /&gt;&lt;br /&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_6268.jpg" /&gt;&lt;br /&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_6516.jpg" /&gt;&lt;br /&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_6553-1.jpg" /&gt;&lt;br /&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_6585-1.jpg" /&gt;&lt;br /&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_6630-3.jpg"&gt;&lt;br /&gt;&lt;a href="http://www.briterevolution.com/artists/matthew-perryman-jones/"&gt;LISTEN&lt;/a&gt;&lt;/p&gt;
</textarea></div>
	<script type="text/javascript">
	// <![CDATA[
...
<span id="last-edit">Last edited by lauradart on March 28, 2009 at 9:14 pm</span>	</span>
	<br class="clear" />
</div>
...
<table id="list-table">
	...
	<tr id='meta-421' class='alternate'>
		<td class='left'><label class='hidden' for='meta[421][key]'>Key</label><input name='meta[421][key]' id='meta[421][key]' tabindex='6' type='text' size='20' value='blogger_author' />
		<div class='submit'><input name='deletemeta[421]' type='submit' class='delete:the-list:meta-421::_ajax_nonce=17d3d89506 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-421::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[421][value]'>Value</label><textarea name='meta[421][value]' id='meta[421][value]' tabindex='6' rows='2' cols='30'>d'art photographiehttp://www.blogger.com/profile/02391660224391645129noreply@blogger.com</textarea></td>
	</tr>
	<tr id='meta-420' class=''>
		<td class='left'><label class='hidden' for='meta[420][key]'>Key</label><input name='meta[420][key]' id='meta[420][key]' tabindex='6' type='text' size='20' value='blogger_blog' />
		<div class='submit'><input name='deletemeta[420]' type='submit' class='delete:the-list:meta-420::_ajax_nonce=870da94191 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-420::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[420][value]'>Value</label><textarea name='meta[420][value]' id='meta[420][value]' tabindex='6' rows='2' cols='30'>dartphoto.blogspot.com</textarea></td>
	</tr>
	<tr id='meta-422' class='alternate'>
		<td class='left'><label class='hidden' for='meta[422][key]'>Key</label><input name='meta[422][key]' id='meta[422][key]' tabindex='6' type='text' size='20' value='blogger_permalink' />
		<div class='submit'><input name='deletemeta[422]' type='submit' class='delete:the-list:meta-422::_ajax_nonce=135ed014ce deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-422::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[422][value]'>Value</label><textarea name='meta[422][value]' id='meta[422][value]' tabindex='6' rows='2' cols='30'>/2009/03/matthew-perryman-jones.html</textarea></td>
	</tr>
	<tr id='meta-546' class=' hidden'>
		<td class='left'><label class='hidden' for='meta[546][key]'>Key</label><input name='meta[546][key]' id='meta[546][key]' tabindex='6' type='text' size='20' value='_edit_last' />
		<div class='submit'><input name='deletemeta[546]' type='submit' class='delete:the-list:meta-546::_ajax_nonce=0ebf2b40d2 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-546::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[546][value]'>Value</label><textarea name='meta[546][value]' id='meta[546][value]' tabindex='6' rows='2' cols='30'>2</textarea></td>
	</tr>
	<tr id='meta-545' class='alternate hidden'>
		<td class='left'><label class='hidden' for='meta[545][key]'>Key</label><input name='meta[545][key]' id='meta[545][key]' tabindex='6' type='text' size='20' value='_edit_lock' />
		<div class='submit'><input name='deletemeta[545]' type='submit' class='delete:the-list:meta-545::_ajax_nonce=beba4367a0 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-545::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[545][value]'>Value</label><textarea name='meta[545][value]' id='meta[545][value]' tabindex='6' rows='2' cols='30'>1281648306</textarea></td>
	</tr>	</tbody>
</table>
...
<div class="inside">
<label class="hidden" for="post_name">Post Slug</label><input name="post_name" type="text" size="13" id="post_name" value="matthew-perryman-jones" />
</div>
</div>
...
</div><input type="hidden" id="wp-old-slug" name="wp-old-slug" value="matthew-perryman-jones" /><div id='advanced-sortables' class='meta-box-sortables'>
</div>
</div>
</div>
<br class="clear" />
...
<table style="display:none;"><tbody id="com-reply"><tr id="replyrow"><td colspan="4">
	...
	<input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="5cb220db7c" />	<input type="hidden" id="_wp_unfiltered_html_comment" name="_wp_unfiltered_html_comment" value="b3debf4120" /></td></tr></tbody></table>
</form>
