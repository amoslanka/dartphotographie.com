...
<input type="hidden" id="_wpnonce" name="_wpnonce" value="7b602b48fd" /><input type="hidden" name="_wp_http_referer" value="/blog/wp-admin/post.php?action=edit&amp;post=236" />
...
<input type='hidden' id='post_ID' name='post_ID' value='236' />
...
<a class="preview button" href="../katie-herzig/index.html" target="wp-preview" id="post-preview" tabindex="4">Preview</a>
...
<div class="misc-pub-section curtime misc-pub-section-last">
	<span id="timestamp">
	Published on: <b>Mar 26, 2009 @ 13:21</b></span>
...
<input type="hidden" id="hidden_mn" name="hidden_mn" value="21" />
...
<a class="submitdelete deletion" href="post-29602.php" onclick="if ( confirm('You are about to delete this post \'katie herzig\'\n  \'Cancel\' to stop, \'OK\' to delete.') ) {return true;}return false;">Delete</a>
</div>
...
<div id="titlediv">
<div id="titlewrap">
	<input type="text" name="post_title" size="30" tabindex="1" value="katie herzig" id="title" autocomplete="off" />
</div>
<div class="inside">
	<div id="edit-slug-box">
<strong>Permalink:</strong>
<span id="sample-permalink">http://dartphotographie.com/blog/<span id="editable-post-name" title="Click to edit this part of the permalink">katie-herzig</span><span id="editable-post-name-full">katie-herzig</span>/</span>
<span id="edit-slug-buttons"><a href="#post_name" class="edit-slug button" onclick="edit_permalink(236); return false;">Edit</a></span>
	</div>
</div>
</div>
...
<div id="postdivrich" class="postarea">
	...
	<div id="editor-toolbar">
			...
			Upload/Insert 
	<a href="media-upload-7590.php" id="add_image" class="thickbox" title='Add an Image'><img src='images/media-button-image.gif' alt='Add an Image' /></a>
	<a href="media-upload-31732.php" id="add_video" class="thickbox" title='Add Video'><img src='images/media-button-video.gif' alt='Add Video' /></a>
	<a href="media-upload-46170.php" id="add_audio" class="thickbox" title='Add Audio'><img src='images/media-button-music.gif' alt='Add Audio' /></a>
	<a href="media-upload-16762.php" id="add_media" class="thickbox" title='Add Media'><img src='images/media-button-other.gif' alt='Add Media' /></a>
			</div>
			</div>
	...
	<div id='editorcontainer'><textarea rows='10' cols='40' name='content' tabindex='2' id='content'>&lt;p&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_1871-2.jpg" /&gt;&lt;br /&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_1860.jpg" /&gt;&lt;br /&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_1847.jpg" /&gt;&lt;br /&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_1725.jpg" /&gt;&lt;br /&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/KH_01.jpg" /&gt;&lt;br /&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_1502.jpg" /&gt;&lt;br /&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_1621.jpg" /&gt;&lt;/p&gt;
...
<span id="last-edit">Last edited by lauradart on March 26, 2009 at 1:21 pm</span>	</span>
	<br class="clear" />
</div>
...
<table id="list-table">
	...
	<tr id='meta-418' class='alternate'>
		<td class='left'><label class='hidden' for='meta[418][key]'>Key</label><input name='meta[418][key]' id='meta[418][key]' tabindex='6' type='text' size='20' value='blogger_author' />
		<div class='submit'><input name='deletemeta[418]' type='submit' class='delete:the-list:meta-418::_ajax_nonce=070dd6b198 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-418::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[418][value]'>Value</label><textarea name='meta[418][value]' id='meta[418][value]' tabindex='6' rows='2' cols='30'>d'art photographiehttp://www.blogger.com/profile/02391660224391645129noreply@blogger.com</textarea></td>
	</tr>
	<tr id='meta-417' class=''>
		<td class='left'><label class='hidden' for='meta[417][key]'>Key</label><input name='meta[417][key]' id='meta[417][key]' tabindex='6' type='text' size='20' value='blogger_blog' />
		<div class='submit'><input name='deletemeta[417]' type='submit' class='delete:the-list:meta-417::_ajax_nonce=c9e6578611 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-417::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[417][value]'>Value</label><textarea name='meta[417][value]' id='meta[417][value]' tabindex='6' rows='2' cols='30'>dartphoto.blogspot.com</textarea></td>
	</tr>
	<tr id='meta-419' class='alternate'>
		<td class='left'><label class='hidden' for='meta[419][key]'>Key</label><input name='meta[419][key]' id='meta[419][key]' tabindex='6' type='text' size='20' value='blogger_permalink' />
		<div class='submit'><input name='deletemeta[419]' type='submit' class='delete:the-list:meta-419::_ajax_nonce=bcaf18f66c deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-419::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[419][value]'>Value</label><textarea name='meta[419][value]' id='meta[419][value]' tabindex='6' rows='2' cols='30'>/2009/03/katie-herzig_26.html</textarea></td>
	</tr>
	<tr id='meta-548' class=' hidden'>
		<td class='left'><label class='hidden' for='meta[548][key]'>Key</label><input name='meta[548][key]' id='meta[548][key]' tabindex='6' type='text' size='20' value='_edit_last' />
		<div class='submit'><input name='deletemeta[548]' type='submit' class='delete:the-list:meta-548::_ajax_nonce=c165de23e7 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-548::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[548][value]'>Value</label><textarea name='meta[548][value]' id='meta[548][value]' tabindex='6' rows='2' cols='30'>2</textarea></td>
	</tr>
	<tr id='meta-547' class='alternate hidden'>
		<td class='left'><label class='hidden' for='meta[547][key]'>Key</label><input name='meta[547][key]' id='meta[547][key]' tabindex='6' type='text' size='20' value='_edit_lock' />
		<div class='submit'><input name='deletemeta[547]' type='submit' class='delete:the-list:meta-547::_ajax_nonce=02e0b87975 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-547::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[547][value]'>Value</label><textarea name='meta[547][value]' id='meta[547][value]' tabindex='6' rows='2' cols='30'>1281648309</textarea></td>
	</tr>	</tbody>
</table>
...
<div class="inside">
<label class="hidden" for="post_name">Post Slug</label><input name="post_name" type="text" size="13" id="post_name" value="katie-herzig" />
</div>
</div>
...
</div><input type="hidden" id="wp-old-slug" name="wp-old-slug" value="katie-herzig" /><div id='advanced-sortables' class='meta-box-sortables'>
</div>
</div>
</div>
<br class="clear" />
...
<table style="display:none;"><tbody id="com-reply"><tr id="replyrow"><td colspan="4">
	...
	<input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="5cb220db7c" />	<input type="hidden" id="_wp_unfiltered_html_comment" name="_wp_unfiltered_html_comment" value="69994ff9d3" /></td></tr></tbody></table>
</form>
