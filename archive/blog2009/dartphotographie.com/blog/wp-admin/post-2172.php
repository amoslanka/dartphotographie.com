...
<input type="hidden" id="_wpnonce" name="_wpnonce" value="8a055d42fb" /><input type="hidden" name="_wp_http_referer" value="/blog/wp-admin/post.php?action=edit&amp;post=201" />
...
<input type='hidden' id='post_ID' name='post_ID' value='201' />
...
<a class="preview button" href="../amie-2/index.html" target="wp-preview" id="post-preview" tabindex="4">Preview</a>
...
<div class="misc-pub-section curtime misc-pub-section-last">
	<span id="timestamp">
	Published on: <b>Nov 6, 2008 @ 1:57</b></span>
...
</select><input type="text" id="jj" name="jj" value="06" size="2" maxlength="2" tabindex="4" autocomplete="off" />, <input type="text" id="aa" name="aa" value="2008" size="4" maxlength="5" tabindex="4" autocomplete="off" /> @ <input type="text" id="hh" name="hh" value="01" size="2" maxlength="2" tabindex="4" autocomplete="off" /> : <input type="text" id="mn" name="mn" value="57" size="2" maxlength="2" tabindex="4" autocomplete="off" /><input type="hidden" id="ss" name="ss" value="00" />

<input type="hidden" id="hidden_mm" name="hidden_mm" value="11" />
<input type="hidden" id="cur_mm" name="cur_mm" value="08" />
<input type="hidden" id="hidden_jj" name="hidden_jj" value="06" />
...
<input type="hidden" id="hidden_mn" name="hidden_mn" value="57" />
...
<a class="submitdelete deletion" href="post-42765.php" onclick="if ( confirm('You are about to delete this post \'amie\'\n  \'Cancel\' to stop, \'OK\' to delete.') ) {return true;}return false;">Delete</a>
</div>
...
<div id="titlediv">
<div id="titlewrap">
	<input type="text" name="post_title" size="30" tabindex="1" value="amie" id="title" autocomplete="off" />
</div>
<div class="inside">
	<div id="edit-slug-box">
<strong>Permalink:</strong>
<span id="sample-permalink">http://dartphotographie.com/blog/<span id="editable-post-name" title="Click to edit this part of the permalink">amie-2</span><span id="editable-post-name-full">amie-2</span>/</span>
<span id="edit-slug-buttons"><a href="#post_name" class="edit-slug button" onclick="edit_permalink(201); return false;">Edit</a></span>
	</div>
</div>
</div>
...
<div id="postdivrich" class="postarea">
	...
	<div id="editor-toolbar">
			...
			Upload/Insert 
	<a href="media-upload-6696.php" id="add_image" class="thickbox" title='Add an Image'><img src='images/media-button-image.gif' alt='Add an Image' /></a>
	<a href="media-upload-31866.php" id="add_video" class="thickbox" title='Add Video'><img src='images/media-button-video.gif' alt='Add Video' /></a>
	<a href="media-upload-46036.php" id="add_audio" class="thickbox" title='Add Audio'><img src='images/media-button-music.gif' alt='Add Audio' /></a>
	<a href="media-upload-6339.php" id="add_media" class="thickbox" title='Add Media'><img src='images/media-button-other.gif' alt='Add Media' /></a>
			</div>
			</div>
	...
	<div id='editorcontainer'><textarea rows='10' cols='40' name='content' tabindex='2' id='content'>&lt;p&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;#038;current=IMG_0176.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_0176.jpg" border="0" alt="Photobucket"&gt;&lt;/a&gt;&lt;br /&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;#038;current=IMG_0178.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_0178.jpg" border="0" alt="Photobucket"&gt;&lt;/a&gt;&lt;/p&gt;
</textarea></div>
	<script type="text/javascript">
	// <![CDATA[
...
<table id="list-table">
	...
	<tr id='meta-313' class='alternate'>
		<td class='left'><label class='hidden' for='meta[313][key]'>Key</label><input name='meta[313][key]' id='meta[313][key]' tabindex='6' type='text' size='20' value='blogger_author' />
		<div class='submit'><input name='deletemeta[313]' type='submit' class='delete:the-list:meta-313::_ajax_nonce=c0ed5c28c5 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-313::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[313][value]'>Value</label><textarea name='meta[313][value]' id='meta[313][value]' tabindex='6' rows='2' cols='30'>d'art photographiehttp://www.blogger.com/profile/02391660224391645129noreply@blogger.com</textarea></td>
	</tr>
	<tr id='meta-312' class=''>
		<td class='left'><label class='hidden' for='meta[312][key]'>Key</label><input name='meta[312][key]' id='meta[312][key]' tabindex='6' type='text' size='20' value='blogger_blog' />
		<div class='submit'><input name='deletemeta[312]' type='submit' class='delete:the-list:meta-312::_ajax_nonce=6a66e5d513 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-312::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[312][value]'>Value</label><textarea name='meta[312][value]' id='meta[312][value]' tabindex='6' rows='2' cols='30'>dartphoto.blogspot.com</textarea></td>
	</tr>
	<tr id='meta-314' class='alternate'>
		<td class='left'><label class='hidden' for='meta[314][key]'>Key</label><input name='meta[314][key]' id='meta[314][key]' tabindex='6' type='text' size='20' value='blogger_permalink' />
		<div class='submit'><input name='deletemeta[314]' type='submit' class='delete:the-list:meta-314::_ajax_nonce=58467bc9b1 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-314::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[314][value]'>Value</label><textarea name='meta[314][value]' id='meta[314][value]' tabindex='6' rows='2' cols='30'>/2008/11/amie.html</textarea></td>
	</tr>
	<tr id='meta-610' class=' hidden'>
		<td class='left'><label class='hidden' for='meta[610][key]'>Key</label><input name='meta[610][key]' id='meta[610][key]' tabindex='6' type='text' size='20' value='_edit_last' />
		<div class='submit'><input name='deletemeta[610]' type='submit' class='delete:the-list:meta-610::_ajax_nonce=3c21574b96 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-610::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[610][value]'>Value</label><textarea name='meta[610][value]' id='meta[610][value]' tabindex='6' rows='2' cols='30'>2</textarea></td>
	</tr>
	<tr id='meta-609' class='alternate hidden'>
		<td class='left'><label class='hidden' for='meta[609][key]'>Key</label><input name='meta[609][key]' id='meta[609][key]' tabindex='6' type='text' size='20' value='_edit_lock' />
		<div class='submit'><input name='deletemeta[609]' type='submit' class='delete:the-list:meta-609::_ajax_nonce=67941a3911 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-609::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[609][value]'>Value</label><textarea name='meta[609][value]' id='meta[609][value]' tabindex='6' rows='2' cols='30'>1281648324</textarea></td>
	</tr>	</tbody>
</table>
...
<div class="inside">
<label class="hidden" for="post_name">Post Slug</label><input name="post_name" type="text" size="13" id="post_name" value="amie-2" />
</div>
</div>
...
<ul class='post-revisions'>
	<li><a href='revision-18960.php'>6 November, 2008 @ 1:57</a> by lauradart</li>
</ul></div>
</div>
</div><input type="hidden" id="wp-old-slug" name="wp-old-slug" value="amie-2" /><div id='advanced-sortables' class='meta-box-sortables'>
</div>
</div>
</div>
<br class="clear" />
...
<table style="display:none;"><tbody id="com-reply"><tr id="replyrow"><td colspan="4">
	...
	<input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="5cb220db7c" />	<input type="hidden" id="_wp_unfiltered_html_comment" name="_wp_unfiltered_html_comment" value="8128296a8b" /></td></tr></tbody></table>
</form>
