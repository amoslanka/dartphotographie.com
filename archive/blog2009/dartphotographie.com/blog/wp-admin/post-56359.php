...
<input type="hidden" id="_wpnonce" name="_wpnonce" value="6ae9ebbbcc" /><input type="hidden" name="_wp_http_referer" value="/blog/wp-admin/post.php?action=edit&amp;post=239" />
...
<input type='hidden' id='post_ID' name='post_ID' value='239' />
...
<a class="preview button" href="../griffin-house/index.html" target="wp-preview" id="post-preview" tabindex="4">Preview</a>
...
<div class="misc-pub-section curtime misc-pub-section-last">
	<span id="timestamp">
	Published on: <b>Apr 7, 2009 @ 22:02</b></span>
...
<input type="hidden" id="hidden_mn" name="hidden_mn" value="02" />
...
<a class="submitdelete deletion" href="post-60956.php" onclick="if ( confirm('You are about to delete this post \'Griffin House\'\n  \'Cancel\' to stop, \'OK\' to delete.') ) {return true;}return false;">Delete</a>
</div>
...
<div id="titlediv">
<div id="titlewrap">
	<input type="text" name="post_title" size="30" tabindex="1" value="Griffin House" id="title" autocomplete="off" />
</div>
<div class="inside">
	<div id="edit-slug-box">
<strong>Permalink:</strong>
<span id="sample-permalink">http://dartphotographie.com/blog/<span id="editable-post-name" title="Click to edit this part of the permalink">griffin-house</span><span id="editable-post-name-full">griffin-house</span>/</span>
<span id="edit-slug-buttons"><a href="#post_name" class="edit-slug button" onclick="edit_permalink(239); return false;">Edit</a></span>
	</div>
</div>
</div>
...
<div id="postdivrich" class="postarea">
	...
	<div id="editor-toolbar">
			...
			Upload/Insert 
	<a href="media-upload-56484.php" id="add_image" class="thickbox" title='Add an Image'><img src='images/media-button-image.gif' alt='Add an Image' /></a>
	<a href="media-upload-47862.php" id="add_video" class="thickbox" title='Add Video'><img src='images/media-button-video.gif' alt='Add Video' /></a>
	<a href="media-upload-30040.php" id="add_audio" class="thickbox" title='Add Audio'><img src='images/media-button-music.gif' alt='Add Audio' /></a>
	<a href="media-upload-14432.php" id="add_media" class="thickbox" title='Add Media'><img src='images/media-button-other.gif' alt='Add Media' /></a>
			</div>
			</div>
	...
	<div id='editorcontainer'><textarea rows='10' cols='40' name='content' tabindex='2' id='content'>&lt;p&gt;HELLO &lt;/p&gt;
&lt;p&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/GH_0101.jpg"&gt;&lt;br /&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/GH_0102.jpg"&gt;&lt;br /&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/GH_0103.jpg"&gt;&lt;br /&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/GH_0106.jpg"&gt;&lt;br /&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/GH_0108.jpg"&gt;&lt;/p&gt;
</textarea></div>
	<script type="text/javascript">
	// <![CDATA[
...
<span id="last-edit">Last edited by lauradart on April 7, 2009 at 10:02 pm</span>	</span>
	<br class="clear" />
</div>
...
<table id="list-table">
	...
	<tr id='meta-427' class='alternate'>
		<td class='left'><label class='hidden' for='meta[427][key]'>Key</label><input name='meta[427][key]' id='meta[427][key]' tabindex='6' type='text' size='20' value='blogger_author' />
		<div class='submit'><input name='deletemeta[427]' type='submit' class='delete:the-list:meta-427::_ajax_nonce=c285f0b95f deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-427::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[427][value]'>Value</label><textarea name='meta[427][value]' id='meta[427][value]' tabindex='6' rows='2' cols='30'>d'art photographiehttp://www.blogger.com/profile/02391660224391645129noreply@blogger.com</textarea></td>
	</tr>
	<tr id='meta-426' class=''>
		<td class='left'><label class='hidden' for='meta[426][key]'>Key</label><input name='meta[426][key]' id='meta[426][key]' tabindex='6' type='text' size='20' value='blogger_blog' />
		<div class='submit'><input name='deletemeta[426]' type='submit' class='delete:the-list:meta-426::_ajax_nonce=5fbfc5c670 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-426::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[426][value]'>Value</label><textarea name='meta[426][value]' id='meta[426][value]' tabindex='6' rows='2' cols='30'>dartphoto.blogspot.com</textarea></td>
	</tr>
	<tr id='meta-428' class='alternate'>
		<td class='left'><label class='hidden' for='meta[428][key]'>Key</label><input name='meta[428][key]' id='meta[428][key]' tabindex='6' type='text' size='20' value='blogger_permalink' />
		<div class='submit'><input name='deletemeta[428]' type='submit' class='delete:the-list:meta-428::_ajax_nonce=10558eb6c5 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-428::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[428][value]'>Value</label><textarea name='meta[428][value]' id='meta[428][value]' tabindex='6' rows='2' cols='30'>/2009/04/griffin-house.html</textarea></td>
	</tr>
	<tr id='meta-542' class=' hidden'>
		<td class='left'><label class='hidden' for='meta[542][key]'>Key</label><input name='meta[542][key]' id='meta[542][key]' tabindex='6' type='text' size='20' value='_edit_last' />
		<div class='submit'><input name='deletemeta[542]' type='submit' class='delete:the-list:meta-542::_ajax_nonce=35103a589d deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-542::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[542][value]'>Value</label><textarea name='meta[542][value]' id='meta[542][value]' tabindex='6' rows='2' cols='30'>2</textarea></td>
	</tr>
	<tr id='meta-541' class='alternate hidden'>
		<td class='left'><label class='hidden' for='meta[541][key]'>Key</label><input name='meta[541][key]' id='meta[541][key]' tabindex='6' type='text' size='20' value='_edit_lock' />
		<div class='submit'><input name='deletemeta[541]' type='submit' class='delete:the-list:meta-541::_ajax_nonce=33ac399f3e deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-541::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[541][value]'>Value</label><textarea name='meta[541][value]' id='meta[541][value]' tabindex='6' rows='2' cols='30'>1281648300</textarea></td>
	</tr>	</tbody>
</table>
...
<div class="inside">
<label class="hidden" for="post_name">Post Slug</label><input name="post_name" type="text" size="13" id="post_name" value="griffin-house" />
</div>
</div>
...
</div><input type="hidden" id="wp-old-slug" name="wp-old-slug" value="griffin-house" /><div id='advanced-sortables' class='meta-box-sortables'>
</div>
</div>
</div>
<br class="clear" />
...
<table style="display:none;"><tbody id="com-reply"><tr id="replyrow"><td colspan="4">
	...
	<input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="5cb220db7c" />	<input type="hidden" id="_wp_unfiltered_html_comment" name="_wp_unfiltered_html_comment" value="9bd568d384" /></td></tr></tbody></table>
</form>
