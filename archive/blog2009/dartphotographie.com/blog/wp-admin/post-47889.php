...
<input type="hidden" id="_wpnonce" name="_wpnonce" value="fb054ccc52" /><input type="hidden" name="_wp_http_referer" value="/blog/wp-admin/post.php?action=edit&amp;post=194" />
...
<input type='hidden' id='post_ID' name='post_ID' value='194' />
...
<a class="preview button" href="../virginia-and-bret/index.html" target="wp-preview" id="post-preview" tabindex="4">Preview</a>
...
<div class="misc-pub-section curtime misc-pub-section-last">
	<span id="timestamp">
	Published on: <b>Oct 27, 2008 @ 0:33</b></span>
...
</select><input type="text" id="jj" name="jj" value="27" size="2" maxlength="2" tabindex="4" autocomplete="off" />, <input type="text" id="aa" name="aa" value="2008" size="4" maxlength="5" tabindex="4" autocomplete="off" /> @ <input type="text" id="hh" name="hh" value="00" size="2" maxlength="2" tabindex="4" autocomplete="off" /> : <input type="text" id="mn" name="mn" value="33" size="2" maxlength="2" tabindex="4" autocomplete="off" /><input type="hidden" id="ss" name="ss" value="00" />

<input type="hidden" id="hidden_mm" name="hidden_mm" value="10" />
<input type="hidden" id="cur_mm" name="cur_mm" value="08" />
<input type="hidden" id="hidden_jj" name="hidden_jj" value="27" />
...
<a class="submitdelete deletion" href="post-22659.php" onclick="if ( confirm('You are about to delete this post \'virginia and bret\'\n  \'Cancel\' to stop, \'OK\' to delete.') ) {return true;}return false;">Delete</a>
</div>
...
<div id="titlediv">
<div id="titlewrap">
	<input type="text" name="post_title" size="30" tabindex="1" value="virginia and bret" id="title" autocomplete="off" />
</div>
<div class="inside">
	<div id="edit-slug-box">
<strong>Permalink:</strong>
<span id="sample-permalink">http://dartphotographie.com/blog/<span id="editable-post-name" title="Click to edit this part of the permalink">virginia-and-bret</span><span id="editable-post-name-full">virginia-and-bret</span>/</span>
<span id="edit-slug-buttons"><a href="#post_name" class="edit-slug button" onclick="edit_permalink(194); return false;">Edit</a></span>
	</div>
</div>
</div>
...
<div id="postdivrich" class="postarea">
	...
	<div id="editor-toolbar">
			...
			Upload/Insert 
	<a href="media-upload-19400.php" id="add_image" class="thickbox" title='Add an Image'><img src='images/media-button-image.gif' alt='Add an Image' /></a>
	<a href="media-upload-11674.php" id="add_video" class="thickbox" title='Add Video'><img src='images/media-button-video.gif' alt='Add Video' /></a>
	<a href="media-upload-57908.php" id="add_audio" class="thickbox" title='Add Audio'><img src='images/media-button-music.gif' alt='Add Audio' /></a>
	<a href="media-upload-42933.php" id="add_media" class="thickbox" title='Add Media'><img src='images/media-button-other.gif' alt='Add Media' /></a>
			</div>
			</div>
	...
	<div id='editorcontainer'><textarea rows='10' cols='40' name='content' tabindex='2' id='content'>&lt;p&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;#038;current=b1.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/b1.jpg" border="0" alt="Photobucket"&gt;&lt;/a&gt;&lt;br /&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;#038;current=v3.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/v3.jpg" border="0" alt="Photobucket"&gt;&lt;/a&gt;&lt;br /&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;#038;current=vb1.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/vb1.jpg" border="0" alt="Photobucket"&gt;&lt;/a&gt;&lt;br /&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;#038;current=vb3.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/vb3.jpg" border="0" alt="Photobucket"&gt;&lt;/a&gt;&lt;/p&gt;
</textarea></div>
	<script type="text/javascript">
	// <![CDATA[
...
<table id="list-table">
	...
	<tr id='meta-292' class='alternate'>
		<td class='left'><label class='hidden' for='meta[292][key]'>Key</label><input name='meta[292][key]' id='meta[292][key]' tabindex='6' type='text' size='20' value='blogger_author' />
		<div class='submit'><input name='deletemeta[292]' type='submit' class='delete:the-list:meta-292::_ajax_nonce=e6c3393497 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-292::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[292][value]'>Value</label><textarea name='meta[292][value]' id='meta[292][value]' tabindex='6' rows='2' cols='30'>d'art photographiehttp://www.blogger.com/profile/02391660224391645129noreply@blogger.com</textarea></td>
	</tr>
	<tr id='meta-291' class=''>
		<td class='left'><label class='hidden' for='meta[291][key]'>Key</label><input name='meta[291][key]' id='meta[291][key]' tabindex='6' type='text' size='20' value='blogger_blog' />
		<div class='submit'><input name='deletemeta[291]' type='submit' class='delete:the-list:meta-291::_ajax_nonce=19eb6a2f0d deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-291::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[291][value]'>Value</label><textarea name='meta[291][value]' id='meta[291][value]' tabindex='6' rows='2' cols='30'>dartphoto.blogspot.com</textarea></td>
	</tr>
	<tr id='meta-293' class='alternate'>
		<td class='left'><label class='hidden' for='meta[293][key]'>Key</label><input name='meta[293][key]' id='meta[293][key]' tabindex='6' type='text' size='20' value='blogger_permalink' />
		<div class='submit'><input name='deletemeta[293]' type='submit' class='delete:the-list:meta-293::_ajax_nonce=d3c2de2805 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-293::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[293][value]'>Value</label><textarea name='meta[293][value]' id='meta[293][value]' tabindex='6' rows='2' cols='30'>/2008/10/virginia-and-bret.html</textarea></td>
	</tr>
	<tr id='meta-624' class=' hidden'>
		<td class='left'><label class='hidden' for='meta[624][key]'>Key</label><input name='meta[624][key]' id='meta[624][key]' tabindex='6' type='text' size='20' value='_edit_last' />
		<div class='submit'><input name='deletemeta[624]' type='submit' class='delete:the-list:meta-624::_ajax_nonce=e1cb25b2d2 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-624::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[624][value]'>Value</label><textarea name='meta[624][value]' id='meta[624][value]' tabindex='6' rows='2' cols='30'>2</textarea></td>
	</tr>
	<tr id='meta-623' class='alternate hidden'>
		<td class='left'><label class='hidden' for='meta[623][key]'>Key</label><input name='meta[623][key]' id='meta[623][key]' tabindex='6' type='text' size='20' value='_edit_lock' />
		<div class='submit'><input name='deletemeta[623]' type='submit' class='delete:the-list:meta-623::_ajax_nonce=e13a676238 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-623::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[623][value]'>Value</label><textarea name='meta[623][value]' id='meta[623][value]' tabindex='6' rows='2' cols='30'>1281648327</textarea></td>
	</tr>	</tbody>
</table>
...
<div class="inside">
<label class="hidden" for="post_name">Post Slug</label><input name="post_name" type="text" size="13" id="post_name" value="virginia-and-bret" />
</div>
</div>
...
<ul class='post-revisions'>
	<li><a href='revision-39152.php'>27 October, 2008 @ 0:33</a> by lauradart</li>
</ul></div>
</div>
</div><input type="hidden" id="wp-old-slug" name="wp-old-slug" value="virginia-and-bret" /><div id='advanced-sortables' class='meta-box-sortables'>
</div>
</div>
</div>
<br class="clear" />
...
<table style="display:none;"><tbody id="com-reply"><tr id="replyrow"><td colspan="4">
	...
	<input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="5cb220db7c" />	<input type="hidden" id="_wp_unfiltered_html_comment" name="_wp_unfiltered_html_comment" value="bbe87b917b" /></td></tr></tbody></table>
</form>
