...
<input type="hidden" id="_wpnonce" name="_wpnonce" value="c44c341616" /><input type="hidden" name="_wp_http_referer" value="/blog/wp-admin/post.php?action=edit&amp;post=221" />
...
<input type='hidden' id='post_ID' name='post_ID' value='221' />
...
<a class="preview button" href="../12409/index.html" target="wp-preview" id="post-preview" tabindex="4">Preview</a>
...
<div class="misc-pub-section curtime misc-pub-section-last">
	<span id="timestamp">
	Published on: <b>Jan 26, 2009 @ 18:36</b></span>
...
<a class="submitdelete deletion" href="post-49817.php" onclick="if ( confirm('You are about to delete this post \'1.24.09\'\n  \'Cancel\' to stop, \'OK\' to delete.') ) {return true;}return false;">Delete</a>
</div>
...
<div id="titlediv">
<div id="titlewrap">
	<input type="text" name="post_title" size="30" tabindex="1" value="1.24.09" id="title" autocomplete="off" />
</div>
<div class="inside">
	<div id="edit-slug-box">
<strong>Permalink:</strong>
<span id="sample-permalink">http://dartphotographie.com/blog/<span id="editable-post-name" title="Click to edit this part of the permalink">12409</span><span id="editable-post-name-full">12409</span>/</span>
<span id="edit-slug-buttons"><a href="#post_name" class="edit-slug button" onclick="edit_permalink(221); return false;">Edit</a></span>
	</div>
</div>
</div>
...
<div id="postdivrich" class="postarea">
	...
	<div id="editor-toolbar">
			...
			Upload/Insert 
	<a href="media-upload-21248.php" id="add_image" class="thickbox" title='Add an Image'><img src='images/media-button-image.gif' alt='Add an Image' /></a>
	<a href="media-upload-13650.php" id="add_video" class="thickbox" title='Add Video'><img src='images/media-button-video.gif' alt='Add Video' /></a>
	<a href="media-upload-64252.php" id="add_audio" class="thickbox" title='Add Audio'><img src='images/media-button-music.gif' alt='Add Audio' /></a>
	<a href="media-upload-14599.php" id="add_media" class="thickbox" title='Add Media'><img src='images/media-button-other.gif' alt='Add Media' /></a>
			</div>
			</div>
	...
	<div id='editorcontainer'><textarea rows='10' cols='40' name='content' tabindex='2' id='content'>&lt;p&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;amp;current=A_03.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/A_03.jpg" border="0" alt="Photobucket" /&gt;&lt;/a&gt;&lt;br /&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;amp;current=A_01.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/A_01.jpg" border="0" alt="Photobucket" /&gt;&lt;/a&gt;&lt;br /&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;amp;current=A_08.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/A_08.jpg" border="0" alt="Photobucket" /&gt;&lt;/a&gt;&lt;br /&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;amp;current=A_12.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/A_12.jpg" border="0" alt="Photobucket" /&gt;&lt;/a&gt;&lt;br /&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;amp;current=A_16.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/A_16.jpg" border="0" alt="Photobucket" /&gt;&lt;/a&gt;&lt;/p&gt;
&lt;p&gt;&lt;a href="http://www.myspace.com/andrewstonestreet"&gt;LISTEN&lt;/a&gt;&lt;/p&gt;
</textarea></div>
	<script type="text/javascript">
	// <![CDATA[
...
<span id="last-edit">Last edited by lauradart on January 26, 2009 at 6:36 pm</span>	</span>
	<br class="clear" />
</div>
...
<table id="list-table">
	...
	<tr id='meta-373' class='alternate'>
		<td class='left'><label class='hidden' for='meta[373][key]'>Key</label><input name='meta[373][key]' id='meta[373][key]' tabindex='6' type='text' size='20' value='blogger_author' />
		<div class='submit'><input name='deletemeta[373]' type='submit' class='delete:the-list:meta-373::_ajax_nonce=d84cbf02fd deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-373::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[373][value]'>Value</label><textarea name='meta[373][value]' id='meta[373][value]' tabindex='6' rows='2' cols='30'>d'art photographiehttp://www.blogger.com/profile/02391660224391645129noreply@blogger.com</textarea></td>
	</tr>
	<tr id='meta-372' class=''>
		<td class='left'><label class='hidden' for='meta[372][key]'>Key</label><input name='meta[372][key]' id='meta[372][key]' tabindex='6' type='text' size='20' value='blogger_blog' />
		<div class='submit'><input name='deletemeta[372]' type='submit' class='delete:the-list:meta-372::_ajax_nonce=8a91df372c deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-372::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[372][value]'>Value</label><textarea name='meta[372][value]' id='meta[372][value]' tabindex='6' rows='2' cols='30'>dartphoto.blogspot.com</textarea></td>
	</tr>
	<tr id='meta-374' class='alternate'>
		<td class='left'><label class='hidden' for='meta[374][key]'>Key</label><input name='meta[374][key]' id='meta[374][key]' tabindex='6' type='text' size='20' value='blogger_permalink' />
		<div class='submit'><input name='deletemeta[374]' type='submit' class='delete:the-list:meta-374::_ajax_nonce=adb47f4f8b deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-374::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[374][value]'>Value</label><textarea name='meta[374][value]' id='meta[374][value]' tabindex='6' rows='2' cols='30'>/2009/01/photobucket_26.html</textarea></td>
	</tr>
	<tr id='meta-556' class=' hidden'>
		<td class='left'><label class='hidden' for='meta[556][key]'>Key</label><input name='meta[556][key]' id='meta[556][key]' tabindex='6' type='text' size='20' value='_edit_last' />
		<div class='submit'><input name='deletemeta[556]' type='submit' class='delete:the-list:meta-556::_ajax_nonce=718abafb1c deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-556::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[556][value]'>Value</label><textarea name='meta[556][value]' id='meta[556][value]' tabindex='6' rows='2' cols='30'>2</textarea></td>
	</tr>
	<tr id='meta-555' class='alternate hidden'>
		<td class='left'><label class='hidden' for='meta[555][key]'>Key</label><input name='meta[555][key]' id='meta[555][key]' tabindex='6' type='text' size='20' value='_edit_lock' />
		<div class='submit'><input name='deletemeta[555]' type='submit' class='delete:the-list:meta-555::_ajax_nonce=2147f89d8b deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-555::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[555][value]'>Value</label><textarea name='meta[555][value]' id='meta[555][value]' tabindex='6' rows='2' cols='30'>1281648312</textarea></td>
	</tr>	</tbody>
</table>
...
<div class="inside">
<label class="hidden" for="post_name">Post Slug</label><input name="post_name" type="text" size="13" id="post_name" value="12409" />
</div>
</div>
...
</div><input type="hidden" id="wp-old-slug" name="wp-old-slug" value="12409" /><div id='advanced-sortables' class='meta-box-sortables'>
</div>
</div>
</div>
<br class="clear" />
...
<table style="display:none;"><tbody id="com-reply"><tr id="replyrow"><td colspan="4">
	...
	<input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="5cb220db7c" />	<input type="hidden" id="_wp_unfiltered_html_comment" name="_wp_unfiltered_html_comment" value="b8771f88ce" /></td></tr></tbody></table>
</form>
