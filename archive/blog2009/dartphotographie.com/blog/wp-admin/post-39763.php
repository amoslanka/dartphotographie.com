...
<input type="hidden" id="_wpnonce" name="_wpnonce" value="3e83a5e53f" /><input type="hidden" name="_wp_http_referer" value="/blog/wp-admin/post.php?action=edit&amp;post=196" />
...
<input type='hidden' id='post_ID' name='post_ID' value='196' />
...
<a class="preview button" href="../sarah-anne-denver/index.html" target="wp-preview" id="post-preview" tabindex="4">Preview</a>
...
<div class="misc-pub-section curtime misc-pub-section-last">
	<span id="timestamp">
	Published on: <b>Oct 27, 2008 @ 10:44</b></span>
...
<a class="submitdelete deletion" href="post-5076.php" onclick="if ( confirm('You are about to delete this post \'Sarah Anne, denver\'\n  \'Cancel\' to stop, \'OK\' to delete.') ) {return true;}return false;">Delete</a>
</div>
...
<div id="titlediv">
<div id="titlewrap">
	<input type="text" name="post_title" size="30" tabindex="1" value="Sarah Anne, denver" id="title" autocomplete="off" />
</div>
<div class="inside">
	<div id="edit-slug-box">
<strong>Permalink:</strong>
<span id="sample-permalink">http://dartphotographie.com/blog/<span id="editable-post-name" title="Click to edit this part of the permalink">sarah-anne-denver</span><span id="editable-post-name-full">sarah-anne-denver</span>/</span>
<span id="edit-slug-buttons"><a href="#post_name" class="edit-slug button" onclick="edit_permalink(196); return false;">Edit</a></span>
	</div>
</div>
</div>
...
<div id="postdivrich" class="postarea">
	...
	<div id="editor-toolbar">
			...
			Upload/Insert 
	<a href="media-upload-24836.php" id="add_image" class="thickbox" title='Add an Image'><img src='images/media-button-image.gif' alt='Add an Image' /></a>
	<a href="media-upload-1878.php" id="add_video" class="thickbox" title='Add Video'><img src='images/media-button-video.gif' alt='Add Video' /></a>
	<a href="media-upload-51448.php" id="add_audio" class="thickbox" title='Add Audio'><img src='images/media-button-music.gif' alt='Add Audio' /></a>
	<a href="media-upload-59356.php" id="add_media" class="thickbox" title='Add Media'><img src='images/media-button-other.gif' alt='Add Media' /></a>
			</div>
			</div>
	...
	<div id='editorcontainer'><textarea rows='10' cols='40' name='content' tabindex='2' id='content'>&lt;p&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;#038;current=s1.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/s1.jpg" border="0" alt="Photobucket"&gt;&lt;/a&gt;&lt;br /&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;#038;current=s2.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/s2.jpg" border="0" alt="Photobucket"&gt;&lt;/a&gt;&lt;/p&gt;
</textarea></div>
	<script type="text/javascript">
	// <![CDATA[
...
<table id="list-table">
	...
	<tr id='meta-298' class='alternate'>
		<td class='left'><label class='hidden' for='meta[298][key]'>Key</label><input name='meta[298][key]' id='meta[298][key]' tabindex='6' type='text' size='20' value='blogger_author' />
		<div class='submit'><input name='deletemeta[298]' type='submit' class='delete:the-list:meta-298::_ajax_nonce=e8e6ac57a2 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-298::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[298][value]'>Value</label><textarea name='meta[298][value]' id='meta[298][value]' tabindex='6' rows='2' cols='30'>d'art photographiehttp://www.blogger.com/profile/02391660224391645129noreply@blogger.com</textarea></td>
	</tr>
	<tr id='meta-297' class=''>
		<td class='left'><label class='hidden' for='meta[297][key]'>Key</label><input name='meta[297][key]' id='meta[297][key]' tabindex='6' type='text' size='20' value='blogger_blog' />
		<div class='submit'><input name='deletemeta[297]' type='submit' class='delete:the-list:meta-297::_ajax_nonce=3cc08c6aae deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-297::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[297][value]'>Value</label><textarea name='meta[297][value]' id='meta[297][value]' tabindex='6' rows='2' cols='30'>dartphoto.blogspot.com</textarea></td>
	</tr>
	<tr id='meta-299' class='alternate'>
		<td class='left'><label class='hidden' for='meta[299][key]'>Key</label><input name='meta[299][key]' id='meta[299][key]' tabindex='6' type='text' size='20' value='blogger_permalink' />
		<div class='submit'><input name='deletemeta[299]' type='submit' class='delete:the-list:meta-299::_ajax_nonce=7648effdbe deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-299::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[299][value]'>Value</label><textarea name='meta[299][value]' id='meta[299][value]' tabindex='6' rows='2' cols='30'>/2008/10/sarah-anne.html</textarea></td>
	</tr>
	<tr id='meta-614' class=' hidden'>
		<td class='left'><label class='hidden' for='meta[614][key]'>Key</label><input name='meta[614][key]' id='meta[614][key]' tabindex='6' type='text' size='20' value='_edit_last' />
		<div class='submit'><input name='deletemeta[614]' type='submit' class='delete:the-list:meta-614::_ajax_nonce=551b606edc deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-614::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[614][value]'>Value</label><textarea name='meta[614][value]' id='meta[614][value]' tabindex='6' rows='2' cols='30'>2</textarea></td>
	</tr>
	<tr id='meta-613' class='alternate hidden'>
		<td class='left'><label class='hidden' for='meta[613][key]'>Key</label><input name='meta[613][key]' id='meta[613][key]' tabindex='6' type='text' size='20' value='_edit_lock' />
		<div class='submit'><input name='deletemeta[613]' type='submit' class='delete:the-list:meta-613::_ajax_nonce=02906fc73d deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-613::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[613][value]'>Value</label><textarea name='meta[613][value]' id='meta[613][value]' tabindex='6' rows='2' cols='30'>1281648325</textarea></td>
	</tr>	</tbody>
</table>
...
<div class="inside">
<label class="hidden" for="post_name">Post Slug</label><input name="post_name" type="text" size="13" id="post_name" value="sarah-anne-denver" />
</div>
</div>
...
<ul class='post-revisions'>
	<li><a href='revision-47282.php'>27 October, 2008 @ 10:44</a> by lauradart</li>
</ul></div>
</div>
</div><input type="hidden" id="wp-old-slug" name="wp-old-slug" value="sarah-anne-denver" /><div id='advanced-sortables' class='meta-box-sortables'>
</div>
</div>
</div>
<br class="clear" />
...
<table style="display:none;"><tbody id="com-reply"><tr id="replyrow"><td colspan="4">
	...
	<input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="5cb220db7c" />	<input type="hidden" id="_wp_unfiltered_html_comment" name="_wp_unfiltered_html_comment" value="9226dffd58" /></td></tr></tbody></table>
</form>
