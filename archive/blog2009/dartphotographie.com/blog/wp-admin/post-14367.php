...
<input type="hidden" id="_wpnonce" name="_wpnonce" value="34bdebb3e4" /><input type="hidden" name="_wp_http_referer" value="/blog/wp-admin/post.php?action=edit&amp;post=202" />
...
<input type='hidden' id='post_ID' name='post_ID' value='202' />
...
<a class="preview button" href="../lovelies/index.html" target="wp-preview" id="post-preview" tabindex="4">Preview</a>
...
<div class="misc-pub-section curtime misc-pub-section-last">
	<span id="timestamp">
	Published on: <b>Nov 7, 2008 @ 1:39</b></span>
...
<a class="submitdelete deletion" href="post-7660.php" onclick="if ( confirm('You are about to delete this post \'lovelies\'\n  \'Cancel\' to stop, \'OK\' to delete.') ) {return true;}return false;">Delete</a>
</div>
...
<div id="titlediv">
<div id="titlewrap">
	<input type="text" name="post_title" size="30" tabindex="1" value="lovelies" id="title" autocomplete="off" />
</div>
<div class="inside">
	<div id="edit-slug-box">
<strong>Permalink:</strong>
<span id="sample-permalink">http://dartphotographie.com/blog/<span id="editable-post-name" title="Click to edit this part of the permalink">lovelies</span><span id="editable-post-name-full">lovelies</span>/</span>
<span id="edit-slug-buttons"><a href="#post_name" class="edit-slug button" onclick="edit_permalink(202); return false;">Edit</a></span>
	</div>
</div>
</div>
...
<div id="postdivrich" class="postarea">
	...
	<div id="editor-toolbar">
			...
			Upload/Insert 
	<a href="media-upload-9602.php" id="add_image" class="thickbox" title='Add an Image'><img src='images/media-button-image.gif' alt='Add an Image' /></a>
	<a href="media-upload-17360.php" id="add_video" class="thickbox" title='Add Video'><img src='images/media-button-video.gif' alt='Add Video' /></a>
	<a href="media-upload-35966.php" id="add_audio" class="thickbox" title='Add Audio'><img src='images/media-button-music.gif' alt='Add Audio' /></a>
	<a href="media-upload-61582.php" id="add_media" class="thickbox" title='Add Media'><img src='images/media-button-other.gif' alt='Add Media' /></a>
			</div>
			</div>
	...
	<div id='editorcontainer'><textarea rows='10' cols='40' name='content' tabindex='2' id='content'>&lt;p&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;#038;current=IMG_9975.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_9975.jpg" border="0" alt="Photobucket"&gt;&lt;/a&gt;&lt;br /&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;#038;current=IMG_9994.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_9994.jpg" border="0" alt="Photobucket"&gt;&lt;/a&gt;&lt;br /&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;#038;current=IMG_9934.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_9934.jpg" border="0" alt="Photobucket"&gt;&lt;/a&gt;&lt;/p&gt;
</textarea></div>
	<script type="text/javascript">
	// <![CDATA[
...
<table id="list-table">
	...
	<tr id='meta-316' class='alternate'>
		<td class='left'><label class='hidden' for='meta[316][key]'>Key</label><input name='meta[316][key]' id='meta[316][key]' tabindex='6' type='text' size='20' value='blogger_author' />
		<div class='submit'><input name='deletemeta[316]' type='submit' class='delete:the-list:meta-316::_ajax_nonce=8f7b2f22fd deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-316::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[316][value]'>Value</label><textarea name='meta[316][value]' id='meta[316][value]' tabindex='6' rows='2' cols='30'>d'art photographiehttp://www.blogger.com/profile/02391660224391645129noreply@blogger.com</textarea></td>
	</tr>
	<tr id='meta-315' class=''>
		<td class='left'><label class='hidden' for='meta[315][key]'>Key</label><input name='meta[315][key]' id='meta[315][key]' tabindex='6' type='text' size='20' value='blogger_blog' />
		<div class='submit'><input name='deletemeta[315]' type='submit' class='delete:the-list:meta-315::_ajax_nonce=f0343417d7 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-315::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[315][value]'>Value</label><textarea name='meta[315][value]' id='meta[315][value]' tabindex='6' rows='2' cols='30'>dartphoto.blogspot.com</textarea></td>
	</tr>
	<tr id='meta-317' class='alternate'>
		<td class='left'><label class='hidden' for='meta[317][key]'>Key</label><input name='meta[317][key]' id='meta[317][key]' tabindex='6' type='text' size='20' value='blogger_permalink' />
		<div class='submit'><input name='deletemeta[317]' type='submit' class='delete:the-list:meta-317::_ajax_nonce=c6e7b3005f deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-317::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[317][value]'>Value</label><textarea name='meta[317][value]' id='meta[317][value]' tabindex='6' rows='2' cols='30'>/2008/11/photobucket.html</textarea></td>
	</tr>
	<tr id='meta-608' class=' hidden'>
		<td class='left'><label class='hidden' for='meta[608][key]'>Key</label><input name='meta[608][key]' id='meta[608][key]' tabindex='6' type='text' size='20' value='_edit_last' />
		<div class='submit'><input name='deletemeta[608]' type='submit' class='delete:the-list:meta-608::_ajax_nonce=30440a4786 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-608::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[608][value]'>Value</label><textarea name='meta[608][value]' id='meta[608][value]' tabindex='6' rows='2' cols='30'>2</textarea></td>
	</tr>
	<tr id='meta-607' class='alternate hidden'>
		<td class='left'><label class='hidden' for='meta[607][key]'>Key</label><input name='meta[607][key]' id='meta[607][key]' tabindex='6' type='text' size='20' value='_edit_lock' />
		<div class='submit'><input name='deletemeta[607]' type='submit' class='delete:the-list:meta-607::_ajax_nonce=10925488b6 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-607::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[607][value]'>Value</label><textarea name='meta[607][value]' id='meta[607][value]' tabindex='6' rows='2' cols='30'>1281648323</textarea></td>
	</tr>	</tbody>
</table>
...
<div class="inside">
<label class="hidden" for="post_name">Post Slug</label><input name="post_name" type="text" size="13" id="post_name" value="lovelies" />
</div>
</div>
...
<ul class='post-revisions'>
	<li><a href='revision-23089.php'>7 November, 2008 @ 1:39</a> by lauradart</li>
</ul></div>
</div>
</div><input type="hidden" id="wp-old-slug" name="wp-old-slug" value="lovelies" /><div id='advanced-sortables' class='meta-box-sortables'>
</div>
</div>
</div>
<br class="clear" />
...
<table style="display:none;"><tbody id="com-reply"><tr id="replyrow"><td colspan="4">
	...
	<input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="5cb220db7c" />	<input type="hidden" id="_wp_unfiltered_html_comment" name="_wp_unfiltered_html_comment" value="e553e8b600" /></td></tr></tbody></table>
</form>
