...
<input type="hidden" id="_wpnonce" name="_wpnonce" value="af2cab6c66" /><input type="hidden" name="_wp_http_referer" value="/blog/wp-admin/post.php?action=edit&amp;post=198" />
...
<input type='hidden' id='post_ID' name='post_ID' value='198' />
...
<a class="preview button" href="../andrew-belle-cd-release-1o3oo8/index.html" target="wp-preview" id="post-preview" tabindex="4">Preview</a>
...
<div class="misc-pub-section curtime misc-pub-section-last">
	<span id="timestamp">
	Published on: <b>Oct 29, 2008 @ 16:52</b></span>
...
<a class="submitdelete deletion" href="post-6065.php" onclick="if ( confirm('You are about to delete this post \'andrew belle, cd release 1o.3o.o8\'\n  \'Cancel\' to stop, \'OK\' to delete.') ) {return true;}return false;">Delete</a>
</div>
...
<div id="titlediv">
<div id="titlewrap">
	<input type="text" name="post_title" size="30" tabindex="1" value="andrew belle, cd release 1o.3o.o8" id="title" autocomplete="off" />
</div>
<div class="inside">
	<div id="edit-slug-box">
<strong>Permalink:</strong>
<span id="sample-permalink">http://dartphotographie.com/blog/<span id="editable-post-name" title="Click to edit this part of the permalink">andrew-belle-cd-release-1o3oo8</span><span id="editable-post-name-full">andrew-belle-cd-release-1o3oo8</span>/</span>
<span id="edit-slug-buttons"><a href="#post_name" class="edit-slug button" onclick="edit_permalink(198); return false;">Edit</a></span>
	</div>
</div>
</div>
...
<div id="postdivrich" class="postarea">
	...
	<div id="editor-toolbar">
			...
			Upload/Insert 
	<a href="media-upload-46432.php" id="add_image" class="thickbox" title='Add an Image'><img src='images/media-button-image.gif' alt='Add an Image' /></a>
	<a href="media-upload-54066.php" id="add_video" class="thickbox" title='Add Video'><img src='images/media-button-video.gif' alt='Add Video' /></a>
	<a href="media-upload-7324.php" id="add_audio" class="thickbox" title='Add Audio'><img src='images/media-button-music.gif' alt='Add Audio' /></a>
	<a href="media-upload-14050.php" id="add_media" class="thickbox" title='Add Media'><img src='images/media-button-other.gif' alt='Add Media' /></a>
			</div>
			</div>
	...
	<div id='editorcontainer'><textarea rows='10' cols='40' name='content' tabindex='2' id='content'>&lt;p&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;#038;current=ab3.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/ab3.jpg" border="0" alt="Photobucket"&gt;&lt;/a&gt;&lt;/p&gt;
</textarea></div>
	<script type="text/javascript">
	// <![CDATA[
...
<table id="list-table">
	...
	<tr id='meta-304' class='alternate'>
		<td class='left'><label class='hidden' for='meta[304][key]'>Key</label><input name='meta[304][key]' id='meta[304][key]' tabindex='6' type='text' size='20' value='blogger_author' />
		<div class='submit'><input name='deletemeta[304]' type='submit' class='delete:the-list:meta-304::_ajax_nonce=f6d4c0287b deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-304::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[304][value]'>Value</label><textarea name='meta[304][value]' id='meta[304][value]' tabindex='6' rows='2' cols='30'>d'art photographiehttp://www.blogger.com/profile/02391660224391645129noreply@blogger.com</textarea></td>
	</tr>
	<tr id='meta-303' class=''>
		<td class='left'><label class='hidden' for='meta[303][key]'>Key</label><input name='meta[303][key]' id='meta[303][key]' tabindex='6' type='text' size='20' value='blogger_blog' />
		<div class='submit'><input name='deletemeta[303]' type='submit' class='delete:the-list:meta-303::_ajax_nonce=67bde9b694 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-303::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[303][value]'>Value</label><textarea name='meta[303][value]' id='meta[303][value]' tabindex='6' rows='2' cols='30'>dartphoto.blogspot.com</textarea></td>
	</tr>
	<tr id='meta-305' class='alternate'>
		<td class='left'><label class='hidden' for='meta[305][key]'>Key</label><input name='meta[305][key]' id='meta[305][key]' tabindex='6' type='text' size='20' value='blogger_permalink' />
		<div class='submit'><input name='deletemeta[305]' type='submit' class='delete:the-list:meta-305::_ajax_nonce=a47b0ed570 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-305::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[305][value]'>Value</label><textarea name='meta[305][value]' id='meta[305][value]' tabindex='6' rows='2' cols='30'>/2008/10/andrew-belle-cd-release.html</textarea></td>
	</tr>
	<tr id='meta-620' class=' hidden'>
		<td class='left'><label class='hidden' for='meta[620][key]'>Key</label><input name='meta[620][key]' id='meta[620][key]' tabindex='6' type='text' size='20' value='_edit_last' />
		<div class='submit'><input name='deletemeta[620]' type='submit' class='delete:the-list:meta-620::_ajax_nonce=c587cd77c8 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-620::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[620][value]'>Value</label><textarea name='meta[620][value]' id='meta[620][value]' tabindex='6' rows='2' cols='30'>2</textarea></td>
	</tr>
	<tr id='meta-619' class='alternate hidden'>
		<td class='left'><label class='hidden' for='meta[619][key]'>Key</label><input name='meta[619][key]' id='meta[619][key]' tabindex='6' type='text' size='20' value='_edit_lock' />
		<div class='submit'><input name='deletemeta[619]' type='submit' class='delete:the-list:meta-619::_ajax_nonce=73a1557e62 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-619::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[619][value]'>Value</label><textarea name='meta[619][value]' id='meta[619][value]' tabindex='6' rows='2' cols='30'>1281648326</textarea></td>
	</tr>	</tbody>
</table>
...
<div class="inside">
<label class="hidden" for="post_name">Post Slug</label><input name="post_name" type="text" size="13" id="post_name" value="andrew-belle-cd-release-1o3oo8" />
</div>
</div>
...
<ul class='post-revisions'>
	<li><a href='revision-55412.php'>29 October, 2008 @ 16:52</a> by lauradart</li>
</ul></div>
</div>
</div><input type="hidden" id="wp-old-slug" name="wp-old-slug" value="andrew-belle-cd-release-1o3oo8" /><div id='advanced-sortables' class='meta-box-sortables'>
</div>
</div>
</div>
<br class="clear" />
...
<table style="display:none;"><tbody id="com-reply"><tr id="replyrow"><td colspan="4">
	...
	<input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="5cb220db7c" />	<input type="hidden" id="_wp_unfiltered_html_comment" name="_wp_unfiltered_html_comment" value="3f8e931dd6" /></td></tr></tbody></table>
</form>
