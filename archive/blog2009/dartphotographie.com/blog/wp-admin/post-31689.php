...
<input type="hidden" id="_wpnonce" name="_wpnonce" value="819d67cab5" /><input type="hidden" name="_wp_http_referer" value="/blog/wp-admin/post.php?action=edit&amp;post=215" />
...
<input type='hidden' id='post_ID' name='post_ID' value='215' />
...
<a class="preview button" href="../trent-dabbs-raise-the-tree/index.html" target="wp-preview" id="post-preview" tabindex="4">Preview</a>
...
<div class="misc-pub-section curtime misc-pub-section-last">
	<span id="timestamp">
	Published on: <b>Dec 22, 2008 @ 13:04</b></span>
...
</select><input type="text" id="jj" name="jj" value="22" size="2" maxlength="2" tabindex="4" autocomplete="off" />, <input type="text" id="aa" name="aa" value="2008" size="4" maxlength="5" tabindex="4" autocomplete="off" /> @ <input type="text" id="hh" name="hh" value="13" size="2" maxlength="2" tabindex="4" autocomplete="off" /> : <input type="text" id="mn" name="mn" value="04" size="2" maxlength="2" tabindex="4" autocomplete="off" /><input type="hidden" id="ss" name="ss" value="00" />

<input type="hidden" id="hidden_mm" name="hidden_mm" value="12" />
<input type="hidden" id="cur_mm" name="cur_mm" value="08" />
<input type="hidden" id="hidden_jj" name="hidden_jj" value="22" />
...
<a class="submitdelete deletion" href="post-17106.php" onclick="if ( confirm('You are about to delete this post \'Trent Dabbs: Raise the Tree\'\n  \'Cancel\' to stop, \'OK\' to delete.') ) {return true;}return false;">Delete</a>
</div>
...
<div id="titlediv">
<div id="titlewrap">
	<input type="text" name="post_title" size="30" tabindex="1" value="Trent Dabbs: Raise the Tree" id="title" autocomplete="off" />
</div>
<div class="inside">
	<div id="edit-slug-box">
<strong>Permalink:</strong>
<span id="sample-permalink">http://dartphotographie.com/blog/<span id="editable-post-name" title="Click to edit this part of the permalink">trent-dabbs-raise-the-tree</span><span id="editable-post-name-full">trent-dabbs-raise-the-tree</span>/</span>
<span id="edit-slug-buttons"><a href="#post_name" class="edit-slug button" onclick="edit_permalink(215); return false;">Edit</a></span>
	</div>
</div>
</div>
...
<div id="postdivrich" class="postarea">
	...
	<div id="editor-toolbar">
			...
			Upload/Insert 
	<a href="media-upload-27428.php" id="add_image" class="thickbox" title='Add an Image'><img src='images/media-button-image.gif' alt='Add an Image' /></a>
	<a href="media-upload-3446.php" id="add_video" class="thickbox" title='Add Video'><img src='images/media-button-video.gif' alt='Add Video' /></a>
	<a href="media-upload-49880.php" id="add_audio" class="thickbox" title='Add Audio'><img src='images/media-button-music.gif' alt='Add Audio' /></a>
	<a href="media-upload-35059.php" id="add_media" class="thickbox" title='Add Media'><img src='images/media-button-other.gif' alt='Add Media' /></a>
			</div>
			</div>
	...
	<div id='editorcontainer'><textarea rows='10' cols='40' name='content' tabindex='2' id='content'>&lt;p&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;amp;current=IMG_8145-1.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_8145-1.jpg" border="0" alt="Photobucket" /&gt;&lt;/a&gt;&lt;br /&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;amp;current=IMG_8124.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/IMG_8124.jpg" border="0" alt="Photobucket" /&gt;&lt;/a&gt;&lt;br /&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;amp;current=tree1.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/tree1.jpg" border="0" alt="Photobucket" /&gt;&lt;/a&gt;&lt;br /&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;amp;current=lightbulb.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/lightbulb.jpg" border="0" alt="Photobucket" /&gt;&lt;/a&gt;&lt;br /&gt;&lt;a href="http://s276.photobucket.com/albums/kk4/dartphoto/?action=view&amp;amp;current=tree3.jpg" target="_blank"&gt;&lt;img src="http://i276.photobucket.com/albums/kk4/dartphoto/tree3.jpg" border="0" alt="Photobucket" /&gt;&lt;/a&gt;
&lt;div&gt;&lt;span class="Apple-style-span"  style="text-decoration: underline; font-family:'times new roman';"&gt;&lt;span class="Apple-style-span" style="color: rgb(85, 26, 139);"&gt;&lt;a href="http://www.myspace.com/trentdabbs"&gt;LISTEN&lt;/a&gt;&lt;/span&gt;&lt;span class="Apple-style-span" style="color: rgb(0, 51, 0);"&gt;&lt;/span&gt;&lt;/span&gt;&lt;/div&gt;
</textarea></div>
	<script type="text/javascript">
	// <![CDATA[
...
<table id="list-table">
	...
	<tr id='meta-355' class='alternate'>
		<td class='left'><label class='hidden' for='meta[355][key]'>Key</label><input name='meta[355][key]' id='meta[355][key]' tabindex='6' type='text' size='20' value='blogger_author' />
		<div class='submit'><input name='deletemeta[355]' type='submit' class='delete:the-list:meta-355::_ajax_nonce=6db5b4332d deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-355::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[355][value]'>Value</label><textarea name='meta[355][value]' id='meta[355][value]' tabindex='6' rows='2' cols='30'>d'art photographiehttp://www.blogger.com/profile/02391660224391645129noreply@blogger.com</textarea></td>
	</tr>
	<tr id='meta-354' class=''>
		<td class='left'><label class='hidden' for='meta[354][key]'>Key</label><input name='meta[354][key]' id='meta[354][key]' tabindex='6' type='text' size='20' value='blogger_blog' />
		<div class='submit'><input name='deletemeta[354]' type='submit' class='delete:the-list:meta-354::_ajax_nonce=19ff195fce deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-354::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[354][value]'>Value</label><textarea name='meta[354][value]' id='meta[354][value]' tabindex='6' rows='2' cols='30'>dartphoto.blogspot.com</textarea></td>
	</tr>
	<tr id='meta-356' class='alternate'>
		<td class='left'><label class='hidden' for='meta[356][key]'>Key</label><input name='meta[356][key]' id='meta[356][key]' tabindex='6' type='text' size='20' value='blogger_permalink' />
		<div class='submit'><input name='deletemeta[356]' type='submit' class='delete:the-list:meta-356::_ajax_nonce=5a14ddf0b6 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-356::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[356][value]'>Value</label><textarea name='meta[356][value]' id='meta[356][value]' tabindex='6' rows='2' cols='30'>/2008/12/trent-dabbs-raise-tree_22.html</textarea></td>
	</tr>
	<tr id='meta-500' class=' hidden'>
		<td class='left'><label class='hidden' for='meta[500][key]'>Key</label><input name='meta[500][key]' id='meta[500][key]' tabindex='6' type='text' size='20' value='_edit_last' />
		<div class='submit'><input name='deletemeta[500]' type='submit' class='delete:the-list:meta-500::_ajax_nonce=f4921d5bce deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-500::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[500][value]'>Value</label><textarea name='meta[500][value]' id='meta[500][value]' tabindex='6' rows='2' cols='30'>2</textarea></td>
	</tr>
	<tr id='meta-499' class='alternate hidden'>
		<td class='left'><label class='hidden' for='meta[499][key]'>Key</label><input name='meta[499][key]' id='meta[499][key]' tabindex='6' type='text' size='20' value='_edit_lock' />
		<div class='submit'><input name='deletemeta[499]' type='submit' class='delete:the-list:meta-499::_ajax_nonce=7bd011bf42 deletemeta' tabindex='6' value='Delete' />
		<input name='updatemeta' type='submit' tabindex='6' value='Update' class='add:the-list:meta-499::_ajax_nonce=0a1d1bdc99 updatemeta' /></div><input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="63fb16e43d" /></td>
		<td><label class='hidden' for='meta[499][value]'>Value</label><textarea name='meta[499][value]' id='meta[499][value]' tabindex='6' rows='2' cols='30'>1281648318</textarea></td>
	</tr>	</tbody>
</table>
...
<div class="inside">
<label class="hidden" for="post_name">Post Slug</label><input name="post_name" type="text" size="13" id="post_name" value="trent-dabbs-raise-the-tree" />
</div>
</div>
...
<ul class='post-revisions'>
	<li><a href='revision-39842.php'>22 December, 2008 @ 13:04</a> by lauradart</li>
</ul></div>
</div>
</div><input type="hidden" id="wp-old-slug" name="wp-old-slug" value="trent-dabbs-raise-the-tree" /><div id='advanced-sortables' class='meta-box-sortables'>
</div>
</div>
</div>
<br class="clear" />
...
<table style="display:none;"><tbody id="com-reply"><tr id="replyrow"><td colspan="4">
	...
	<input type="hidden" id="_ajax_nonce" name="_ajax_nonce" value="5cb220db7c" />	<input type="hidden" id="_wp_unfiltered_html_comment" name="_wp_unfiltered_html_comment" value="a15ac82782" /></td></tr></tbody></table>
</form>
